...
Provisionner **Ubuntu Server 24.04 LTS** hôte par hôte (ThinkCentre M710q, Dell OptiPlex 3020M) grâce à **Autoinstall + cloud-init (NoCloud)**, entièrement piloté par Git dans une approche GitOps.
